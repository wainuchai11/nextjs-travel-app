    ...
    >
      <div className="flex h-full flex-col items-start justify-between p-6 lg:px-20 lg:py-10">
        ...
        <div className="flexCenter gap-6">
          ...
          <p className="bolde-16 md:bold-20 text-white">{pepleJoined}</p>
        </div>
      </div>
    </div>
  );
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 w-full overflow-hidden rounded-3xl">
          ...
          <p className="regular-14 xl:regular-16 mt-5 text-white">
            ...
            repudiandae deleniti optio a reiciendis error autem dolores sequi?
            Nemo beatae animi repellendus odio, facere esse praesentium est quia
            numquam culpa.
          </p>
